...
\begin{enumerate}[leftmargin=2cm]
  ...
  \item \textbf{AI Integration:} Connected Pollinations \cite{pollinations2024api} and Replicate \cite{replicate2024whisper} APIs for thumbnail generation, content analysis, transcription via Whisper~v3 \cite{radford2023whisper}, and moderation.
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{3cm}\textit{Screenshot: NepTube Home Page}\vspace{3cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{3cm}\textit{Screenshot: Video Player Page}\vspace{3cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{3cm}\textit{Screenshot: Creator Dashboard}\vspace{3cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.85\textwidth}{\centering\vspace{3cm}\textit{Screenshot: Admin Dashboard}\vspace{3cm}}}
